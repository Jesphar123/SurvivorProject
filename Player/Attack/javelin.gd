...
var spr_jav_reg = preload("res://Textures/Items/Weapons/javelin_ph.png")
var spr_jav_atk = preload("res://Textures/Items/Weapons/javelin_attack_ph.png")
...
func _physics_process(delta):
	if target_array.size() > 0:
		...
		var return_speed = 50
		if abs(distance_dif.x) > 250 or abs(distance_dif.y) > 250:
			return_speed = 250
